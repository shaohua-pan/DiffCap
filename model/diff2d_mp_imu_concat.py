...
class Diff2d_mp_imu_concat(nn.Module):
    def __init__(self, njoints, nfeats, mp_imu_dim, cond_latent_dim=256,
        ...
        self.embed_input = nn.Linear(self.input_feats + self.mp_imu_dim, self.latent_dim)
    ...
    def forward(self, x, timesteps, y=None):
        ...
        mp_imu = y['mp_imu'].reshape(bs*nframes, self.mp_imu_dim)
