...
class DiffusionTranPos(nn.Module):
    def __init__(self, njoints, nfeats, imu_2d_dim, mp_dim,
        ...
        self.embed_input = nn.Linear(self.input_feats + self.imu_2d_dim, self.latent_dim)
    ...
    def forward(self, x, timesteps, y=None):
        ...
        imu_2d = y['imu_2d'].reshape(bs * nframes, self.imu_2d_dim)
        x = torch.cat((x, imu_2d), dim=1)  # [bs*nframes, njoints*nfeats+mp_imu_dim]
